...
const Navbar = () => {
    ...
    return (
        <div className='fixed w-full h-[100px] flex justify-between items-center px-4 bg-[#0c254b] text-white text-xl'>
            ...
            {/* Mobile menu */}
            <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#0c254b] flex flex-col justify-center items-center'}>
                ...
                <li className='py-6 text-4xl txt'>
                    <Link onClick={handleClick} activeClass="active" to="project" smooth={true} duration={500} >
                        Projects
                    </Link>
                </li>
                <li className='py-6 text-4xl txt'>
